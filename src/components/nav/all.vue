<template>
    <div class="allContainer">
        ...
        <ul>
            <li class="list" v-for="v in msg" :key="v.last_reply_at">
                <router-link :to="{path:'/people/' + v.author.loginname,params:{id:v.author.loginname}}"><img :src="v.author.avatar_url" :onerror="logo" alt="头像"></router-link>
                <div class="content">
...
export default {
    ...
    mounted() {
        this.$http.get('https://www.vue-js.com/api/v1/topics?tab=all').then((res) => {
